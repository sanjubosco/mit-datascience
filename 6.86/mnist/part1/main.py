...
#sys.path.append(r"C:\MyCode\mit-datascience\6.86\mnist")
sys.path.append("..")
from utils import *
...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    print (compute_test_error_mod3(train_x, train_y, theta, temp_parameter))
    print (compute_test_error_mod3(test_x, test_y, theta, temp_parameter))
    return test_error
...
print('softmax PCA cubic feature test_error=', test_error)